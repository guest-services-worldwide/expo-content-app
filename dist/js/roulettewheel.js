...
$spin.on('click',function(){
    ...
    setTimeout(function() {
        ...
        const prizeWon = prize(randomNumber);

        let $thisResult = `<li class="previous-result color-${color}">
                            <h1 class="text-xl">Congratuations!</h1>
                            <p>
                                You have won<br />
                                <div style="font-size: 2.2rem;margin-top: 20px;">${prizeWon}</div>
                            </p>
                        </li>`;
